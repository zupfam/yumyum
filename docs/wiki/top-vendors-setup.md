...
- **Detailed Instructions:** Please refer to the `docs/wiki/bigquery-ga4-export-setup.md` document for step-by-step guidance on how to link your GA4 property to BigQuery.
